...
$spacesaverDisplay = ($this->spacesave_heading) ? 'flex' : 'block';
$spacesaverSpacing = ($this->spacesave_heading) ? '0' :'.5rem 0';
$spacesaverHeading = ($this->spacesave_heading) ? '1.5rem' :'2.625rem'; 

$cssVariables = ':root {
  --admin-font-family      :'. $fontFamily         .';
  --admin-font-size        :'. $this->font_size    .';
  ...
  --spacesaver-display     :'. $spacesaverDisplay  .'; 
  --spacesaver-spacing     :'. $spacesaverSpacing  .'; 
  --spacesaver-head-size   :'. $spacesaverHeading  .';  
'; 
